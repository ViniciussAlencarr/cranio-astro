                    ...
                    <div className="bg-white rounded-xl p-3 mt-3 2xl:mt-6">
                        <div className="flex flex-row justify-center items-start md:justify-start">
                            <div className="pr-3 rounded-lg">
                                {book?.cover.url && <img src={`${baseUrl}${book?.cover.url}`} alt="" className='object-contain rounded-lg h-min max-h-[142px] w-inherit max-w-[100px] sm:w-[180px] md:w-[210px] lg:w-[250px] sm:max-w-none 2xl:max-w-none 2xl:h-[368px] 2xl:w-[257px] shadow-xl' />}
                            </div>
