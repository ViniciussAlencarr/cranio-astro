    ...
    return (
        <form onSubmit={onSubmit} className="mt-3 md:mt-6 flex flex-col md:flex-row items-center justify-center w-full">
            <div className="w-full md:w-fit">
                <input required type="email" placeholder="Digite o seu email" className=" py-2 px-8 rounded-full w-full md:w-auto bg-none bg-transparent outline-none border border-[#969696] min-w-auto md:min-w-[400px] 2xl:min-w-[600px] text-[14px] md:text-[16px] 2xl:text-[20px]" />
            </div>
