            ...
            <div className="flex flex-col xl:flex-row items-center w-full">
                <div className="flex items-center justify-between lg:justify-evenly xl:justify-between w-full">
                    ...
                    {statusLoggedText === undefined ? (
                        ...
                        : isLogged ? (<a href="/estante" className="hidden lg:block xl:block cursor-pointer hover:opacity-70 font-semibold text-[14px] md:text-[16px] 2xl:text-[20px]">
                            Área do cliente
                        </a>) : (<a href="/login" className="hidden lg:block xl:block cursor-pointer hover:opacity-70"><UserIcon size={"61"} className="md:w-[50px] lg:w-[58px] xl:w-[61px]" /></a>)}
                </div>
